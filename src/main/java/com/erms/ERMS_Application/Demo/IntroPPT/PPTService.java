...
public class PPTService {
    ...
    public String savePPT(String contentName,String contentType, MultipartFile uploadFile) throws IOException {
        ...
        if (fileType.equals("application/vnd.ms-powerpoint") ||   // PPT
            ...
            PPTEntity pptEntity = new PPTEntity(contentName,contentType, uploadFile.getBytes());
            ...
            PPTEntity pptEntity = new PPTEntity(contentName,contentType ,compressedPdf);
            pptRepo.save(pptEntity);
