...
public class CustomUserDetails implements UserDetails {
    ...
    public CustomUserDetails(OperationTechnicalLeadEntity operationTechnicalLeadEntity) {
        this.email = operationTechnicalLeadEntity.getEmail();
        this.password =operationTechnicalLeadEntity.getPassword();
        this.role = operationTechnicalLeadEntity.getRole();
        this.user = operationTechnicalLeadEntity; // Store the user object
    }
