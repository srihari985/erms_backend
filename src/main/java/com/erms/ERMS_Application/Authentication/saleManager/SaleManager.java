...
public class SaleManager {
    ...
    @OneToMany(mappedBy = "saleManager", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    private List<OperationTechnicalLeadEntity> operationTechnicalLeadEntities;
    ...
    public List<OperationTechnicalLeadEntity> getOperationTechnicalLeadEntities() {
        return operationTechnicalLeadEntities;
    }

    public void setOperationTechnicalLeadEntities(List<OperationTechnicalLeadEntity> operationTechnicalLeadEntities) {
        this.operationTechnicalLeadEntities = operationTechnicalLeadEntities;
    }

    public SaleManager() {
    }

    public SaleManager(Long id, String firstname, String lastname, String email, String password, Role role, String salesManagerId, Managers manager, List<Sales> sales, List<OperationTechnicalLeadEntity> operationTechnicalLeadEntities, List<Technician> technicians) {
        this.id = id;
        this.firstname = firstname;
        this.lastname = lastname;
        this.email = email;
