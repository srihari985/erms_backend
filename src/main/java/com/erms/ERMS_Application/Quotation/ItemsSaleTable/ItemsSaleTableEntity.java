...
public class ItemsSaleTableEntity {
    ...
    public ItemsSaleTableEntity(long itId, String items, String hsn, long qty, float priceItem, float discount, float tax, float amount, String description, String category, LocalDate saleDate, FormEntity formEntity, Sales sales, AddPartyEntity addPartyEntity) {
        this.itId = itId;
        this.items = items;
        this.hsn = hsn;
        this.qty = qty;
